...
export const productsFixture: Product[] = [
  {
    ...
    product_price: 450, sale_price: 399, product_type: "inStore", product_stock_quantity: 12,
    avg_rating: 4.8, review_count: 42, is_visible: true,
  ...
  },
  {
    ...
    product_price: 60, product_type: "inStore", product_stock_quantity: 40,
    avg_rating: 4.5, review_count: 20, is_visible: true,
  ...
  },
  {
    ...
    avg_rating: 4.9, review_count: 15, is_visible: true,
  ...
  },
  {
    ...
    product_price: 150, product_type: "inStore", product_stock_quantity: 0,
    avg_rating: 4.6, review_count: 33, is_visible: false,
  ...
  },
  {
    ...
    category_id: "c_cake_slice", unit_id: "u_piece",
    product_price: 320, sale_price: 280, product_type: "inStore", product_stock_quantity: 5,
    avg_rating: 4.7, review_count: 28, is_visible: true,
